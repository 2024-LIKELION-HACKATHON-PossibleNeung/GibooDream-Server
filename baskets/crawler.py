...
def crawl_search_items(search_item):
    url=f'https://www.coupang.com/np/search?q={search_item}&channel=recent'
    headers = {
    ...
    for item in items:
        ...
        item_url="https://www.coupang.com/"+item_url
